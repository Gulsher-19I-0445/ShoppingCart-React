...
export default function Items() {
  ...
  return (
    <div>
      ...
      <>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            >
              <NavDropdown.Item onClick={() => setCat("all")}>ShowAll</NavDropdown.Item>
              <NavDropdown.Item onClick={() => setCat("men's clothing")}>men's clothing</NavDropdown.Item>
              <NavDropdown.Item onClick={() => setCat("electronics")}>
                electronics
              </NavDropdown.Item>
              <NavDropdown.Item onClick={() => setCat("jewelery")}>Jewelery</NavDropdown.Item>
      ...
      {products.length > 0 && (
        <div className="row">
          {products.map((user) => (         //Send data as props to Card Components
